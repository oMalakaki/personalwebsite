      ...
      projects: [
        {
          ...
          description:
            "For this project, I embarked on a collaborative journey with MAG7's in-house UX/UI designers to breathe new life into the company's website. Recognizing the outdated nature of the existing platform, we set out to reimagine and rebuild it entirely from the ground up. This endeavor allowed me to actively participate in design brainstorming sessions, affording me a profound insight into the intricate facets of UX/UI design and the nuances of crafting content for professional websites.\n\nLeveraging the power of Next.js, I meticulously transformed the design concepts into a fully functional website. This endeavor entailed seamless integration of content management systems, empowering users to effortlessly modify and update website content as needed, ensuring a dynamic and adaptable digital presence for MAG7.",
          skills:
